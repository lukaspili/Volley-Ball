 ...
 */
public class BallRequestFuture<T> extends SingleResponseListener<T> implements Future<T>, Response.ErrorListener {
    ...
    public static <E> BallRequestFuture<E> newFuture() {
        return new BallRequestFuture<E>();
    }

    private BallRequestFuture() {}
